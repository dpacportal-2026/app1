...
export async function sendConfirmationEmail(
  ...
  const html = `
    <div style="font-family: Arial, Helvetica, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px;">
      ...
      <p style="font-size: 24px; font-weight: 700; letter-spacing: 2px; margin: 0 0 16px; color: #111827;">${referenceNo}</p>
      <p style="margin: 0 0 4px; color: #374151;"><strong>Nature / Uri:</strong> ${nature}</p>
      <p style="margin: 0 0 16px; color: #374151;"><strong>Summary / Buod:</strong> ${preview}</p>
